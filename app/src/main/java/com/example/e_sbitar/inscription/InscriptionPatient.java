...
public class InscriptionPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retourBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(InscriptionPatient.this, Connexion.class);
    ...
    public void inscriptionUtilisateurPatient() {
        ...
        if (date_naissanceTable.length != 3){
        ...
        fAuth.createUserWithEmailAndPassword(emailTexte, mdpTexte).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                ...
                uidPatient = patient.getUid();

                bdd = FirebaseDatabase.getInstance();
                patientRef = bdd.getReference().child("Utilisateurs").child("Patients").child(uidPatient);

                HashMap<String, Object> inscriptionMap = new HashMap<>();
                inscriptionMap.put("id", uidPatient);
                ...
                patientRef.updateChildren(inscriptionMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Intent intent = new Intent(InscriptionPatient.this, AccueilPatient.class);
                        startActivity(intent);
                        Toast.makeText(InscriptionPatient.this, "Inscription réussie", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(InscriptionPatient.this, "Inscription échouée", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(InscriptionPatient.this, "Un promblème s'est arrivé", Toast.LENGTH_SHORT).show();
            }
        });
    }
